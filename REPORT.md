...
JengaCoder v1.2 combines a compact 1.54B model, Q4_K_M quantization and llama.cpp CPU inference to achieve 13.35 tokens per second while using approximately 1.69 GB peak resident memory during the official participant profiler run.
